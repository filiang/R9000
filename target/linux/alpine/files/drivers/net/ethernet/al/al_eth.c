...
static void al_eth_get_strings(struct net_device *netdev, u32 stringset, u8 *data)
{
...
static void al_eth_get_ethtool_stats(struct net_device *netdev, struct ethtool_stats *stats, u64 *data)
{
	struct al_eth_adapter *adapter = netdev_priv(netdev);
	struct al_eth_mac_stats *mac_stats = &adapter->mac_stats;
